...
A. [HTML](https://developer.mozilla.org/zh-CN/docs/Web/HTML) **`<datalist>`** 元素包含了一组 [`<option>`](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/option) 元素，这些元素表示其他表单控件可选值。是H5的新增元素.
...
D. **`<legend>`** [HTML](https://developer.mozilla.org/zh-CN/docs/Web/HTML) 元素表示其父元素 [``](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Element/fieldset) 内容的标题。
